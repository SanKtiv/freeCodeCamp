...
function getIndexToIns(arr, num) {
    let funcForSort = (a, b) => a - b;
    let funcForFindIndex = (elem) => elem >= num;
    arr.sort(funcForSort);
    let indexOfArr = arr.findIndex(funcForFindIndex);
    return arr.length ? indexOfArr >= 0 ? indexOfArr : arr.length : 0;
}
